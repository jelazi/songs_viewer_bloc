...
class EditLyricPage extends StatefulWidget {
  ...
  const EditLyricPage({super.key, required this.isOriginalLyrics});

  @override
  State<EditLyricPage> createState() => _EditLyricPageState();
}

class _EditLyricPageState extends State<EditLyricPage> {
